...
Ext.ux.Lightbox = (function(){
    ...
    return {
        ...
        initMarkup: function() {
            ...
            els.outerImageContainer.setSize(350,350);
            els.outerDataContainer.setWidth('350px');
        },
        ...
        open: function(image, sel, group) {
            ...
            els.overlay.fadeIn({
                ...
                callback: function() {
                    ...
                    var lightboxTop = pageScroll.top + 5;
        ...
        setImage: function(index){
            ...
            if( typeof _gaq !== 'undefined' ) { _gaq.push(['_trackEvent', 'Action', 'View Photo', images[activeImage][0]]); }
        },
        ...
        resizeImage: function(w, h){
            ...
            els.outerImageContainer.setSize(wNew, hNew);
        ...
        getViewSize: function() {
            return [Ext.getBody().getWidth(), Ext.getBody().getHeight()];
        }
    }
})();
